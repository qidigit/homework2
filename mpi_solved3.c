...
*  No MPI initialize and Finalize
*  AND the precision of FLOAT is not enough for the large summation!
* SOURCE: Blaise Barney, corrected by Di Qi 
...
// replace the data type to double for precision
